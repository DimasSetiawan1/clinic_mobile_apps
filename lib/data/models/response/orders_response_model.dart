...
class OrdersResponseModel {
  ...
  OrdersResponseModel({required this.status, required this.data});

  OrdersResponseModel copyWith({String? status, List<HistoryOrders>? data}) =>
      OrdersResponseModel(
...
class HistoryOrders {
  ...
  factory HistoryOrders.fromMap(Map<String, dynamic> json) => HistoryOrders(
    ...
    chatRooms: ChatRooms.fromMap(json["chat_rooms"] ?? <String, dynamic>{}),
  );
