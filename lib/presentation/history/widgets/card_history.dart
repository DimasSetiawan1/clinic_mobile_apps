            ...
            Row(
              children: [
                Container(
                  ...
                  child: orders.doctor.image.contains("http")
                      ? Image.network(
                          orders.doctor.image,
                      ...
                      : Image.network(
                          GlobalVariable.baseUrl + orders.doctor.image,
                          errorBuilder: (context, error, stackTrace) {
                            return Image.asset(
                              Assets.images.doctor1.path,
                              width: 87.0,
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SpaceHeight(8),
                      Text(
                        DateFormat("EEEE, dd MM yyyy - hh:mm a", "id_ID")
                        ...
                        children: [
                          ...
                          switch (orders.status) {
                            "PAID" => StatusOrderWigdet(
                                width: 60,
                                textColor: Color(0xff25B865),
                                backgroundColor:
                                    Color(0xff25B865).withOpacity(0.1),
                                status: orders.status),
                            "UNPAID" => StatusOrderWigdet(
                                width: 75,
