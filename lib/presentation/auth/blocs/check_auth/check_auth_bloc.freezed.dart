...
class _$CheckAuthImpl implements _CheckAuth {
  const _$CheckAuthImpl(this.idToken);
  ...
  @override
  String toString() {
    return 'CheckAuthEvent.checkAuth(idToken: $idToken)';
  }
...
abstract class _CheckAuth implements CheckAuthEvent {
  const factory _CheckAuth(final String idToken) = _$CheckAuthImpl;
...
class _$AuthenticatedImpl implements _Authenticated {
  ...
  @override
  String toString() {
    return 'CheckAuthState.authenticated()';
  }
...
abstract class _Authenticated implements CheckAuthState {
...
class _$UnauthenticatedImpl implements _Unauthenticated {
  ...
  @override
  String toString() {
    return 'CheckAuthState.unauthenticated()';
  }
...
abstract class _Unauthenticated implements CheckAuthState {
