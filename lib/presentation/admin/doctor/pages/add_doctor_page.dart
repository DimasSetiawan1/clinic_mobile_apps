                ...
                success: (doctor) {
                  showDialog(
                    ...
                    builder: (context) {
                      return AlertDialog(
                        title: Text('Success'),
                        content: Text('Data dokter berhasil ditambahkan.'),
                        actions: [
                          TextButton(
                            onPressed: () {
                              context.pushAndRemoveUntil(AdminMainPage(1),
                                  ModalRoute.withName('/adminDoctor'));
                            },
                            child: Text('OK'),
                          ),
                        ],
                ...
                return Button.filled(
                  ...
                  onPressed: () {
                    if (_doctorFormKey.currentState != null &&
                      ...
                      context
                          .read<AddDoctorBloc>()
                          .add(AddDoctorEvent.addDoctor(data));
                      // } else {
