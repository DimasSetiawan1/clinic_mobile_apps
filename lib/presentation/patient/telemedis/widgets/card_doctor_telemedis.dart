...
import 'package:clinic_mobile_apps/presentation/patient/telemedis/pages/vidcall_page.dart';

class CardDoctorTelemedis extends StatelessWidget {
  final User user;
  const CardDoctorTelemedis({super.key, required this.user});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          //         ),
          //         Text(
          //           user.telemedicineFee.toString().currencyFormatRpV2,
          //           style: const TextStyle(
          //             fontSize: 13.0,
          //             fontWeight: FontWeight.w600,
