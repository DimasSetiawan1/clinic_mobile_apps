...
import 'package:clinic_mobile_apps/presentation/patient/chat/pages/premium_chat_page.dart';
...
class DetailDoctorPage extends StatelessWidget {
  ...
  const DetailDoctorPage(
      {super.key, required this.doctor, required this.isTelemedis});
          ...
          child: Row(
            ...
            children: [
              ...
              Button.filled(
                ...
                label: isTelemedis ? 'Telpon Sekarang' : 'Chat Sekarang',
                fontSize: 12.0,
              )
            ],
          ),
